...
type CodecovFileCoverage struct {
	common.Model
	...
	FilePath           string     `gorm:"primaryKey;type:varchar(150);index" json:"filePath"`
...
func (CodecovFileCoverage) TableName() string {
	return "_tool_codecov_file_coverages"
}
